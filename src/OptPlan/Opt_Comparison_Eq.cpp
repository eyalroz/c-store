...
#include "Opt_Comparison_Eq.h"

// Default constructor
Opt_Comparison_Eq::Opt_Comparison_Eq() : Opt_Comparison()
{
}
		
// Provide column and table names
Opt_Comparison_Eq::Opt_Comparison_Eq(Opt_Object* ptrLeft, Opt_Object* ptrRight) : Opt_Comparison(ptrLeft, ptrRight, "=")
{
}

// Default Destructor
Opt_Comparison_Eq::~Opt_Comparison_Eq()
{
}

// Clone
Opt_Comparison_Eq* Opt_Comparison_Eq::clone()
{
	...
	return new Opt_Comparison_Eq(ptrLeft, ptrRight);
}

// Clone with new table names, new table alias
Opt_Comparison_Eq* Opt_Comparison_Eq::clone(string sTableName, string sTableAlias)
{
	Opt_Object* ptrLeft = NULL;
	Opt_Object* ptrRight = NULL;
